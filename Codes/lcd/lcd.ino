...
int n1 = 0; // Variable for controlling Relay 1
int n2 = 0; // Variable for controlling Relay 2
int n3 = 0; // Variable for controlling Relay 3
int n4 = 0; // Variable for controlling Relay 4
...
void loop() {
  ...
  if (millis() - lastPrintMillis >= 60000) {
    printLCD();
    lastPrintMillis = millis(); // Update the last print time
  }
